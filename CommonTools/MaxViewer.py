...
class imshow_mark_3d:
    ...
    def get_seed_points(self):
        ...
        im = self.im_sm
        self.gfilt_size_max= getattr(paramaters,'gfilt_size_max',3)
        self.gfilt_size_min= getattr(paramaters,'gfilt_size_min',1)
        #centers = get_seed_points_base(im,gfilt_size=gfilt_size,filt_size=filt_size,th_seed=th_seed,hot_pix_th=hot_pix_th)
        self.all_centers = get_seed_points_base(im,gfilt_size_min=1,gfilt_size_max=self.gfilt_size_max,filt_size=3,th_seed=0.,max_num=None,
